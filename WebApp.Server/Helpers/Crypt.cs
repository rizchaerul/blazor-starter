...
public class AES
{
    ...
    public static string Decrypt(string input, string passphrase, int? keySize = null)
    {
        ...
        {
            aes.KeySize = aes.LegalKeySizes.Max(n => n.MaxSize);
        }
...
public class RSA
{
    ...
    public static string Decrypt(string input, string key)
    {
        ...
        var bytes = Decrypt(Convert.FromBase64String(input), deskey);
    ...
    public static byte[] Decrypt(byte[] input, RSAParameters key)
    {
        ...
        var bytes = rsa.Decrypt(input, RSAEncryptionPadding.OaepSHA1);
    ...
    public static string Encrypt(string input, string key)
    {
        ...
        var bytes = Encrypt(Encoding.UTF8.GetBytes(input), deskey);
    ...
    public static byte[] Encrypt(byte[] input, RSAParameters key)
    {
        ...
        var bytes = rsa.Encrypt(input, RSAEncryptionPadding.OaepSHA1);
    ...
    public static bool GenerateKeys(out string privateKey, out string publicKey, int keySize = 2048)
    {
